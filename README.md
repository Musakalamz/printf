...
The `_printf` function was coded on an Ubuntu 20.04 LTS machine with `gcc` , using the options -Wall -Werror -Wextra -pedantic -std=gnu89
...
* Uchenna T ikejiaku <[Bahdfella](https://github.com/Bahdfella)>
...
ALX School is a full-stack software engineering program
